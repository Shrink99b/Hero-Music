...
from Hero.utils.database import get_authuser_names, get_cmode
from Hero.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Hero.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Veer.stop_stream(message.chat.id)
    except:
        pass
