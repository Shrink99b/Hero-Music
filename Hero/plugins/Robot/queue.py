...
from Hero.utils import (Veerbin, get_channeplayCB,
                              seconds_to_min)
from Hero.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from Hero.utils.decorators.language import language, languageCB
from Hero.utils.inline import queue_back_markup, queue_markup
