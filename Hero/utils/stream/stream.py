...
import config
from Hero import Carbon, YouTube, app
from Hero.core.call import Veer
from Hero.misc import db
from Hero.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from Hero.utils.exceptions import AssistantErr
from Hero.utils.inline.play import (stream_markup,
                                          telegram_markup)
from Hero.utils.inline.playlist import close_markup
from Hero.utils.pastebin import Veerbin
from Hero.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Veer.force_stop_stream(chat_id)
